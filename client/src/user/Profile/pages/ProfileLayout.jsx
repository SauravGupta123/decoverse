          ...
          {(loadedProfileData) => {
            ...
            return (
              <>
                <Helmet>
                  <title>
                    {loadedProfileData.personal_data.name} | Decoverse
                  </title>
                  ...
                  <meta
                    ...
                    content={
                      ...
                      loadedProfileData.personal_data.name} | Check contest ratins and connect today! - Find more about ${loadedProfileData.personal_data.name} on Decoverse`
                    }
                  />
