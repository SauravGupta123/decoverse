...
const socialFields = [
            { icon: <FaInstagram size={30} />, name: "instagram", placeholder: "https://instagram.com/decoverse" },
    { icon: <FaLinkedin size={30} />, name: "linkedin", placeholder: "https://linkedin.com/in/pranshu54" },
    { icon: <FaXTwitter size={30} />, name: "twitter", placeholder: "https://twitter.com/decoverse" },
];
