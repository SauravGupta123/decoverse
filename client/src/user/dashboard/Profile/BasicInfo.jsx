                ...
                <div className="flex-2 rounded-lg shadow bg-dashboardColor border border-jet">
                    ...
                    <div className="px-6 py-8">
                        <div className="sm:w-9/12">
                            ...
                            <textarea style={{ backgroundColor: "RGB(17, 19, 18)" }} className="placeholder:text-gray-600 textarea textarea-bordered h-24 w-full" placeholder="Ex: Developer @ decoverse" maxLength={BIO_LIMIT} onChange={handleInputChangeObjData} value={formData.bio.data} name="bio" id="bio" />
                        </div>
                    </div>
                </div>
            </div>
