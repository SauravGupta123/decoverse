...
export default function SectionOne() {
  ...
  return (
    <div className="font-['Geist'] xl:pt-8 max-md:pt-4 items-center flex flex-col text-center phone:mt-16">
      ...
      >
        {/* <Link to={"https://github.com/decoverse/decoverse"}>
      ...
      <div className="w-10/12">
        ...
        >
          ...
          <span className="block mt-1 md:mt-6 relative">
            <span className="bg-decoverse-bg px-2 relative">
        ...
        >
          Elevate your coding and development journey with decoverse
        </motion.p>
      </div>
      <motion.div
      ...
      >
        ...
        <a href="https://github.com/decoverse/decoverse">
          <img
            className="max-md:w-32 md:w-40"
            src={meltcd}
            draggable={false}
