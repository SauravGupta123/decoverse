        ...
        {contestsData.length ? (
          <>
            <p className="mx-auto text-center mt-4 text-xl">
              Have a favorite contest platform we're missing? {" "} Join our <a href="https://decoverse.com/discord" target="_blank" rel="noopener noreferrer" className="text-decoverse-bg">Discord</a> or <button className="text-decoverse-bg" onClick={handleClick}>
              click here
