        ...
        {hackathonsData.length ? (
          <>
            <p className="mx-auto text-center mt-4 text-xl">
              Want hackathons from more platforms?{" "} Join our <a href="https://decoverse.com/discord" target="_blank" rel="noopener noreferrer" className="text-decoverse-bg">Discord</a> or <button className="text-decoverse-bg" onClick={handleClick}>
                click here
