...
const addToGoogleCalendar = ({ name, hackathonStartTimeUnix: startTimeUnix, duration, url, host }) => {
  ...
  const description = `<hr>🏆<b>Hackathon</b>🏆%0A👨🏻‍💻Name: ${name}%0A🕘Start at: ${formattedStartTimeString}%0A⏱️Duration: ${duration} minutes%0A🚀Host: ${host}%0A🔗Hackathon URL: <a href='${url}'>${url}</a>%0A<hr><i>Thank you for using <a href='https://decoverse.com'>decoverse</a></i>`;
...
function HackathonIndividualCard() {
  ...
  const contentTitle = `${host} | Decoverse`.toLowerCase();
  const pageTitle = `${name} | Decoverse`.toLowerCase();
  if (hackathon)
    return (
      <>
        <Helmet>
            ...
            >
              <div className="ic-mv-child">
                ...
                <div className="ic-mv-child-fifth">
                  ...
                  <a
                    href={url + "?ref=decoverse&utm_source=decoverse"}
                    target="_blank"
