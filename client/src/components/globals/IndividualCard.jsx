...
const addToGoogleCalendar = ({ name, startTimeUnix, duration, url, host, vanity }) => {
  ...
  const description = `<hr>🏆<b>Contest</b>🏆%0A👨🏻‍💻Name: ${name}%0A🕘Start at: ${formattedStartTimeString}%0A⏱️Duration: ${duration} minutes%0A🚀Host: ${host}%0A🔗Contest URL: <a href='${url}'>${url}</a>%0A<hr><i>Thank you for using <a href='https://decoverse.com'>decoverse</a></i>`;
