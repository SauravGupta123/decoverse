...
2. Navigate to the backend directory: `cd decoverse/backend`
...
MONGODB_URL=mongodb://127.0.0.1:27017/decoverse
PORT=4001
...
This `.env` file must be populated with the following environment variables for decoverse to work:

| Variable              | Explanation                                                                                            |
|-----------------------|--------------------------------------------------------------------------------------------------------|
| TEST                  | Marker indicating that the environment file is successfully connected.                                 |
| MONGODB_URL           | URL for connecting Decoverse to the MongoDB database. |
...
## Linking MongoDB
To connect Decoverse to the database side, two options are available: MongoDB atlas or hosting a local instance. Here is a setup guide on both options.
...
- https://decoverse.stoplight.io/docs/decoverse-api
