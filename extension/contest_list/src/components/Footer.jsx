        ...
        <>
            <footer className="w-80 bg-cardsColor p-4 rounded-b-xl mx-auto">
                <div className="footer">
                    <nav className="flex mx-auto">
                        <div className="flex gap-8 lg:gap-3 items-center p-2">
                            ...
                            <a
                                href="https://instagram.com/decoverse"
                ...
                <p className="text-center w-full text-xs">
                    &copy; {copyrightDate} <a href="https://decoverse.com"> Decoverse</a>.{" "}
                    <a
                        href="https://github.com/decoverse/decoverse/blob/main/LICENSE"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="underline"
                    >
                    ...
                    . Contribute on{" "}
                    <a
                        href="https://github.com/decoverse/decoverse"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="underline"
                    >
