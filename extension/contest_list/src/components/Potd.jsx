            ...
            try {
                ...
                chrome.storage.local.get('potdGFG', async function (result) {
                    ...
                    if (formattedToday in potdGFG) {
                        ...
                        try {
                            const response = await axios.get("https://api.decoverse.com/potd/geeksforgeeks");
                ...
                chrome.storage.local.get('potdLeetCode', async function (result) {
                    ...
                    if (formattedToday in potdLeetCode) {
                        ...
                        try {
                            ...
                            const data = await axios.get('https://api.decoverse.com/potd/leetcode');
    ...
    return (
        <>
            <div className="bg-dashboardColor px-4 w-full">
                ...
                {/* <a href="https://decoverse.com/contests" target="_blank" rel="noopener noreferrer" className="text-custom-blue text-center my-2 mx-auto w-full flex items-center justify-center">Explore more...</a> */}
